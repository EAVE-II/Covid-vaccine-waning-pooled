...
df_cc_desc <- df_cc_ps_matches %>%
  ...
  # Baseline characteristics for v2 only
...
# When using cov_ball_vacc_fn on df_cc_desc, for convenience recode 
# vacc column as follows: v1 -> uv, v2 -> vacc
# This is so the functions that were used for first-dose can be re-used with 
# no change
